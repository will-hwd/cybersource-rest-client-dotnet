...
namespace CyberSource.Model
{
    ...
    public partial class CreateSubscriptionRequest :  IEquatable<CreateSubscriptionRequest>, IValidatableObject
    {
        ...
        public CreateSubscriptionRequest(string OrganizationId = default(string), string ReportDefinitionName = default(string), List<string> ReportFields = default(List<string>), ReportMimeTypeEnum? ReportMimeType = default(ReportMimeTypeEnum?), ReportFrequencyEnum? ReportFrequency = default(ReportFrequencyEnum?), string ReportName = default(string), string Timezone = default(string), string StartTime = default(string), int? StartDay = default(int?), Dictionary<string, List<string>> ReportFilters = default(Dictionary<string, List<string>>), ReportingV3ReportsIdGet200ResponseReportPreferences ReportPreferences = default(ReportingV3ReportsIdGet200ResponseReportPreferences), string GroupName = default(string))
        {
            ...
            {
                throw new InvalidDataException("ReportFields is a required property for CreateSubscriptionRequest and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("ReportMimeType is a required property for CreateSubscriptionRequest and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("ReportFrequency is a required property for CreateSubscriptionRequest and cannot be null");
            }
            else
            {
            ...
            if (ReportName == null)
            {
                throw new InvalidDataException("ReportName is a required property for CreateSubscriptionRequest and cannot be null");
            }
            else
            {
            ...
            if (Timezone == null)
            {
                throw new InvalidDataException("Timezone is a required property for CreateSubscriptionRequest and cannot be null");
            }
            else
            {
            ...
            if (StartTime == null)
            {
                throw new InvalidDataException("StartTime is a required property for CreateSubscriptionRequest and cannot be null");
            }
            else
            {
